"""
Django settings for TargetingSearch project.
...
SECRET_KEY = '087u(ahd+gg#p$24^mnf6_y1+cmjf#75&vuk*$st8hg_1g+b)u'
...
ROOT_URLCONF = 'TargetingSearch.urls'
...
WSGI_APPLICATION = 'TargetingSearch.wsgi.application'
